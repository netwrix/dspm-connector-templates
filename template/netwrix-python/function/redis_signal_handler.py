...
class RedisSignalHandler:
    ...
    def check_control_signal(self, execution_id: str, last_message_id: str = "0") -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if "timeout" in str(e).lower():
                logger.debug(f"Redis operation timed out (execution_id={execution_id}, error={str(e)})")
            else:
                logger.warning(f"Error reading control signal (execution_id={execution_id}, error={str(e)})")
    ...
    def health_check(self) -> bool:
        ...
        try:
            ...
            run_with_timeout(self.client.ping, timeout=2)
            return True
