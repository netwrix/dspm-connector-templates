"""
State Management Framework for OpenFaaS Internal Functions

This module provides a framework for managing scan/sync execution states,
including stop/pause/resume operations. Internal functions can declare their
    ...
    class MyFunctionHandler:
        def __init__(self, context):
            self.state_manager = StateManager(
                context=context,
                supported_states={
                    'stop': True,      # This function supports stopping
                    'pause': False,    # This function doesn't support pausing
                    'resume': False    # This function doesn't support resuming
                }
            )
...
class StateManager:
    """
    Manages function execution states (stop/pause/resume).

    Provides a unified interface for all internal functions to:
    ...
    # Default supported states (all internal functions can support stop)
