...
class TestStateManagerInitialization:
    ...
    def test_initialize_no_execution_id(self, mock_context):
        ...
        # Mock the caller_attributes.get() to return None
        mock_context.caller_attributes.get.return_value = None
...
class TestShutdown:
    ...
    def manager(self, mock_context):
        """Create StateManager instance"""
        # Ensure caller_attributes.get returns the scan_execution_id
        mock_context.caller_attributes.get.return_value = "scan-123"
        return StateManager(context=mock_context)
